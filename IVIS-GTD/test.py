...
class UserTest(unittest.TestCase):
    ...
    def test_make_array(self):
        '''
        test the make_array function in the feature module
    ...
    def test_df_sel_btw_years(self):
        '''
        test the df_sel_btw_years function in feature module
        whether the output DataFrame is in the expected time range
        '''
        self.assertTrue(2002 in list(ft.df_sel_btw_years((2000, 2005)).year))
        self.assertFalse(1990 in list(ft.df_sel_btw_years((2000, 2005)).year))


    def test_make_five_year_start(self):
        '''
        test the make_five_year_start function in the feature module
